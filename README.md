...
### Make a git clone (Linux):
    ...
    git clone https://github.com/JuanBindez/DYGTube-Downloader-v3.0-rc8
    
### Access the folder:

    cd DYGTube-Downloader-v3.0-rc8
...
### command to compile:
    ...
    pyinstaller --name DYGTube-v3.0-rc8-x86_64 --onefile --noconsole --windowed main.py
