...
# This is DYGTube Downloader version 2.5.3-rc4

----------

#### you can use this software on windown and linux.
...
### Make a git clone:
    ...
    git clone https://github.com/JuanBindez/DYGTube-Downloader-v2.5.3-rc4
    
### Access the folder:

    cd DYGTube-Downloader-v2.5.3-rc4
